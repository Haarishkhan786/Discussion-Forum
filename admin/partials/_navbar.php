...
if (isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] == true ) {
   ...
   <a href="/forum/profile.php"><p class="mx-2 my-2" style="color:white";> Welcome '.$_SESSION['username'].'</p></a>
   <a href="/forum/partials/_logout.php"><button class="btn btn-danger" type="submit">Logout</button></a>
   ';
   if ($_SESSION['role'] == 'Admin'){
    echo '<a class="nav-link mx-3 btn btn-outline-warning" aria-current="page" href="/forum/admin/adminpanel.php">Admin</a>';
   }
}
